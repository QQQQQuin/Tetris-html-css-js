...
function dropRandom(){
    ...
    if(i==1){
        ...
        fallingPiece = [[0, 3], [0, 4], [0, 5], [0, 6]]

        // (0,3) (0,4) (0,5) (0,6) to fallingPiece?
    }
    else if(i==2){
        a[0][3] = 2;
        a[1][3] = 2;
